...
import {OccupantChange} from '../plugins/multi-user-chat/occupant-change';
...
export class Room implements Recipient {
    ...
    handleOccupantChangedNick(occupant: RoomOccupant, isCurrentUser: boolean, newNick: string) {
        ...
        existingOccupant.jid = new JID(existingOccupant.jid.local, existingOccupant.jid.domain, newNick);
